...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
    	...
    	imprimir("cantidad de notas desaporbadas :  " + an.cantNotasDesaprobatorias());
    	imprimir("cantidad dde notas mayores a 15 :  " + an.cantNotasMayoresA15());
    	imprimir("Primera nota aprobadatoria :  " + an.posPrimeraNotaAprobatoria());
    	imprimir("Penultima nota deaprobatoria :  " + an.posPenultimaNotaDesaprobatoria());
	}
